...
class User extends Database
{
    ...
    public function update($request, $files)
    {
        ...
        $tmp_photo      = $files['photo']['tmp_name']; // holds the actual image from temporary strage
        ...
        if ($this->conn->query($sql)){
            ...
            # if there is an uploaded photo, save it to the db and save the file to iamge folder.
            if ($photo){
